...
- [SQL Server 2019](https://www.microsoft.com/en-us/sql-server/sql-server-downloads) or higher, **Developer Edition**. Choose the [Basic installation](https://www.c-sharpcorner.com/article/how-to-install-sql-server-2019/).
